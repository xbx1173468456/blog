...
<div class="dialog-container">
  ...
  <basic-table-tree ref="refSubContractTreeData" :default-expand-all="defaultExpandAll"
              :data="subContract.treeData" :columns="subContract.treeColumns" :filterNodeMethod="filterNodeMethod"
...
<script>
  ...
  export default {
    ...
    methods: {
       ...
       */
      clickSearchFilter() {
        this.$refs.refBasicSearch.searchFilter(this.$refs.refSubContractTreeData, this.modelSearchFilter, () => {
          try {
            this.$refs.refSubContractTreeData.filter(this.modelSearchFilter.fuzzy);
          } catch (error) {
      ...
      clickDefaultExpandAll() {
        ...
        this.$refs.refSubContractTreeData.toggleExpandedAll(this.defaultExpandAll);
      },
      clickRefresh() {
        this.getSubContractTreeData();
      },
