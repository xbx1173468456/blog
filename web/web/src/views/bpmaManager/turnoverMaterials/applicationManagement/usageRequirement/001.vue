<template>
  <basic-container class="usageRequirementDetail-container-detail">
    <basic-handler>
            ...
            <el-col :span="8">
              <basic-form-item label="审核状态" prop="validateStatus">
                <el-input
                  clearable
                  size="small"
                  v-model="ruleForm.detailList.validateStatus ==1?'已审核':'未审核'"
                  disabled
                  maxlength="100"
                ></el-input>
              </basic-form-item>
            ...
            <el-col :span="8">
              <basic-form-item label="单据名称" prop="name">
                <el-input
                  ...
                  clearable
                  size="small"
                  v-model="ruleForm.detailList.name"
                  :disabled="disabledAudit"
                  maxlength="100"
                ></el-input>
              </basic-form-item>
            ...
            <el-col :span="8">
              <basic-form-item label="项目名称" prop="proName">
                <el-input
                  ...
                  placeholder="请选择项目名称"
                  size="small"
                  v-model="ruleForm.detailList.proName"
                  :disabled="disabledAudit"
                  readonly
                >
                  <el-button
            ...
            <el-col :span="8">
              <basic-form-item label="提出人员" prop="handlePerson">
                <el-input
                  clearable
                  size="small"
                  v-model="ruleForm.detailList.handlePerson"
                  placeholder="请输入提出人员"
                  :disabled="disabledAudit"
                  maxlength="100"
                ></el-input>
            ...
            <el-col :span="8">
              <basic-form-item label="提出日期" prop="handleDate" class="showTime">
                <el-date-picker
                  ...
                  :editable="false"
                  :disabled="disabledAudit"
                  v-model="ruleForm.detailList.handleDate"
                  type="date"
                  placeholder="请选择提出日期"
                  format="yyyy-MM-dd"
                ></el-date-picker>
            ...
            <el-col :span="24">
              <basic-form-item label="补充说明" prop="remark">
                <el-input
                  ...
                  placeholder="请输入补充说明"
                  v-model="ruleForm.detailList.remark"
                ></el-input>
              </basic-form-item>
            </el-col>
          </el-row>
...
//   getDiction,
//   delDetail
// } from "@/api/bpmaManager/goods/putStorage/usageRequirement";
...
export default {
  ...
  methods: {
      ...
      if (this.itemId) {
        getDetail(this.itemId)
          .then(res => {
            if (res.status) {
              this.proObj = {
                code: res.data.detailList.proCode,
                id: res.data.detailList.proId,
                name: res.data.detailList.proName
              };
    ...
    clickByDialogAddData(type) {
      this.type = type;
      if (type == "goodsItem") {
        if (!this.ruleForm.detailList.proId) {
        ...
        if (this.ruleForm.detailList.useEnterpriseType == 1) {
        ...
        if (!this.ruleForm.detailList.offerEnterpriseId)
        ...
        this.getContract(
          ...
          1,
          10,
          this.ruleForm.detailList.proId,
    ...
    getPublicMate(arr) {
      ...
      if (arr[1] == 1) {
        ...
        this.ruleForm.detailList.contractId = arr[0].id;
        this.ruleForm.detailList.contractName = arr[0].name;
      }
    },
    ...
    handleChange(type) {
      ...
      switch (type) {
        case "visibleSyncProject":
          this.ruleForm.detailList.proCode = row.code;
          this.ruleForm.detailList.proId = row.id;
          this.ruleForm.detailList.proName = row.name;
          this.proObj = {
            code: row.code,
            id: row.id,
            name: row.name
      ...
      add(this.ruleForm)
        .then(res => {
          ...
          if (res.status == 200) {
            ...
            this.itemId = res.data.detailList.id;
        ...
        this.$confirm("亲，您是否确定审核当前数据，审核后数据不能修改！", {
          ...
          .then(() => {
            this.putAddAndUpdateAll(id => {
              this.ruleForm.detailList.id = id;
              audit(this.ruleForm)
                .then(res => {
                  if (res.status == 200) {
