<template>
  <basic-container class="contractRegistration-container-detail">
    <basic-handler>
    ...
    <el-collapse v-model="activeNames">
      <el-collapse-item title="基本信息" name="1">
        <el-form :model="ruleForm.bpmaMaterialInInoutMaster" :rules="rules" ref="refRuleForm" label-width="120px"
          ...
          <el-row :gutter="10">
            ...
            <el-col :span="8">
              <basic-form-item label="单位名称" prop="offerEnterpriseName">
                <el-input ref="refOfferEnterpriseName" placeholder="请选择单位名称" size="small"
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <basic-form-item label="本次结算总额" prop="buyTotalPrice">
                <basic-input
                  clearable
                  size="small"
            ...
            <el-col :span="8">
              <basic-form-item label="结算人员" prop="usePerson">
                <el-input clearable size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.usePerson"
                          placeholder="请输入结算人员" :disabled="disabledAudit" maxlength="100"></el-input>
              </basic-form-item>
            </el-col>
             <el-col :span="8">
    ...
    <el-row class="content-container">
      <basic-handler>
        <el-button type="primary" size="small" icon="el-icon-plus" @click="clickWindow('materialDictionary')" :disabled="disabledAudit" plain>周材计量单
        </el-button>
      ...
      <basic-table ref="refOutTheFrontTable" :dataTable="dataStockGoodsData" :columns="columnsData.itemColumns"
        ...
        <template slot-scope="obj" slot="postion">
          <basic-input clearable size="small"  v-model="obj.scope.row.postion" placeholder="请输入结算总额"
                       @change="sumChange(obj.scope.row)" :disabled="disabledAudit"></basic-input>
        </template>
        <template slot-scope="obj" slot="remark">
          <basic-input clearable size="small"  v-model="obj.scope.row.remark" placeholder=""
