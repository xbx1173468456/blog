<template>
  <div class="outTheFront-container-list">
    <basic-handler>
          ...
          <el-row :gutter="10">
            ...
            <el-col :span="8">
              <basic-form-item label="单据名称" prop="name">
                <el-input ref="refName" clearable size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.name" :disabled="isAudit"
            ...
            <el-col :span="8">
              <basic-form-item label="供方单位" prop="offerEnterpriseName">
                <el-input ref="refOfferEnterpriseName" placeholder="请选择供方单位" size="small"
                          v-model="ruleForm.bpmaMaterialInInoutMaster.offerEnterpriseName" :disabled="isAudit" readonly>
                  <el-button slot="append" icon="el-icon-plus" @click="clickByDialogAddData('offerEnterpriseName')"
                             :disabled="isAudit" size="mini"></el-button>
                </el-input>
              </basic-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row :gutter="10">
            ...
            <el-col :span="8">
              <basic-form-item label="垫付人员" prop="payPerson">
                <el-input :disabled="isAudit || ruleForm.bpmaMaterialInInoutMaster.ifSubstitutePay == 2" readOnly
                  ...
                  <el-button @click="toipClick('userManager')" class="el-button-append" icon="el-icon-plus" size="mini"
                             :disabled="isAudit || ruleForm.bpmaMaterialInInoutMaster.ifSubstitutePay == 2"
            ...
            <el-col :span="8">
              <basic-form-item label="领用单位" prop="useEnterpriseName">
                <el-input ref="refUseEnterpriseName" placeholder="请选择领用单位" size="small"
                          v-model="ruleForm.bpmaMaterialInInoutMaster.useEnterpriseName" :disabled="isAudit" readonly>
            ...
            <el-col :span="8">
              <basic-form-item label="领用人员" prop="usePerson">
                <el-input clearable size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.usePerson"
                          placeholder="请输入领用人员" :disabled="isAudit" maxlength="100"></el-input>
              </basic-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row :gutter="10">
            <el-col :span="24">
              <el-form-item label="文档附件" class="add-border file">
                <basic-upload ref="refBasicUpload" :formId="ruleForm.bpmaMaterialInInoutMaster.id" :disabled="isAudit">
                </basic-upload>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="10">
            <el-col :span="8">
              <basic-form-item label="是否报销" prop="ifPay" class="add-border disabled">
                <el-radio-group v-model="ruleForm.bpmaMaterialInInoutMaster.ifPay" :disabled="!isAudit"
                                @change="changePriseType">
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <basic-form-item label="是否抵扣" prop="ifDeduct" class="add-border disabled">
                <el-radio-group v-model="ruleForm.bpmaMaterialInInoutMaster.ifDeduct" :disabled="isAudit"
                                @change="changePriseType">
                  <el-radio :label="parseInt(row.code)" disabled
                            v-for="(row, key, index) in dataEnum.isOrNot" :key="row.code">
                    {{ row.name }}
    ...
    <el-row class="content-container">
      <basic-handler>
        <el-button type="primary" size="small" icon="el-icon-plus" @click="toipClick('materialDictionary')" :disabled="isAudit" plain>引入物资
        </el-button>
      ...
      <basic-table ref="refOutTheFrontTable" :dataTable="dataStockGoodsData" :columns="columnsData.itemColumns"
        ...
        <template slot-scope="obj" slot="ifChangePrice">
          <el-radio-group v-model="obj.scope.row.ifChangePrice" :disabled="isAudit"
          ...
          <el-form :model="dataStockGoodsData.data[obj.scope.$index]" :ref="'formUseUnitPrice' + obj.scope.$index"
            ...
            <el-form-item prop="useUnitPrice">
              <basic-input clearable size="small"  :format="formatToThousandsFour"
                           ...
                           :disabled="obj.scope.row.ifChangePrice==2?true:false||isAudit" :min="0.0000"
