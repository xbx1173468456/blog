  ...
  <basic-split-pane class="bpmaManager-container-list" :default-percent='75' :min-percent='25'>
    <template slot="leftContainer">
      <div class="left-container">
        ...
        <basic-table ref="refPurchaseTable"
...
<script>
  ...
  export default {
    ...
    methods: {
        ...
        getList(this.modelSearchFilter).then(res => {
          if (res.status == 200) {
            ...
            this.$nextTick(function () {
              if(this.$refs.refPurchaseTable){
                this.$refs.refPurchaseTable.setCurrentRow( this.tableData.data[0]);
              }
            });
          }
        }).catch(err => {
       ...
       */
      clickSearchFilter() {
        this.$refs.refBasicSearch.searchFilter(this.$refs.refPurchaseTable, this.modelSearchFilter, () => {
          this.getSelectedProjectData();
        });
      },
      //添加
