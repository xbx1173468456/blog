...
<basic-split-pane class="bpmaManager-container-list" :default-percent='75' :min-percent='25'>
    <template slot="leftContainer">
        <div class="left-container">
            ...
            <basic-table ref="refReturnGoodsTable"
...
export default {
    ...
    methods: {
            ...
            getList(this.modelSearchFilter).then(res => {
                if (res.status == 200) {
                  ...
                  this.$nextTick(function () {
                    if (this.$refs.refReturnGoodsTable) {
                      this.$refs.refReturnGoodsTable.setCurrentRow(this.tableData.data[0]);
                    }
                  });
                }
            }).catch(err => {
         ...
         */
        clickSearchFilter() {
        this.$refs.refBasicSearch.searchFilter(this.$refs.refReturnGoodsTable, this.modelSearchFilter, () => {
            this.getSelectedProjectData();
        });
        },
        //添加
