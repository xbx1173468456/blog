        ...
        <basic-dialog v-el-drag-dialog :title="title" :visible.sync="dialogTableVisible">
            ...
            <div v-else>
                <el-row>
                    ...
                    <el-col :span="16">
                        <tableItem :columns="columns" :tableData="tableData"  :page="page" :highlight="true" @handleCurrentChange="handleCurrentChange" @handleSelectionChange="handleSelectionChange" :typeTable="true" :type="selection"></tableItem>
                    </el-col>
                </el-row>
            </div>
