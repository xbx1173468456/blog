      ...
      <template slot="paneL">
        <div class="right-container">
          <logTable :tableData="tableData" :columns="columns" :page="page" @handleCurrentChange="handleCurrentChange"
            @currentPage="currentPage" ref="logTable" :ifChange="ifChange" :type="selection" @change="handlerChange"
            @handleSelectionChange="handleSelectionChange" :disabled="disabled"></logTable>
        </div>
      </template>
    </split-pane>
  </div>
