...
export function getList(data) {
  return request({
    url: '/api/bpma/bpmaMaterialOutOtherMaster/page',
    method: 'get',
    params: data
  })
}
...
export function getDetail(id) {
  return request({
    url: `/api/bpma/bpmaMaterialOutOtherMaster/getMasterAndDetail/${id}`,
    method: 'get'
  })
}
//查看比选列表详情
...
export function add(data) {
  return request({
    url: '/api/bpma/bpmaMaterialOutOtherMaster/addOrUpdateEnterprise',
    method: 'post',
    data: data
  })
}
...
export function audit(data) {
  return request({
    url: '/api/bpma/bpmaMaterialOutOtherMaster/audit',
    method: 'put',
    data: data
  })
}
...
export function del(id) {
  return request({
    url: `/api/bpma/bpmaMaterialOutOtherMaster/deleteMasterAndDetail/${id}`,
    method: 'delete'
  })
}
//报价单位信息
...
export function getMaterial(params) {
  ...
  export function getPurchaseList(data) {
    return request({
      url: '/api/bpma/bpmaMaterialInStock/page',
      method: 'get',
      params: data
    })
  }
  ...
  export function delDetail(id) {
    return request({
      url: `/api/bpma/bpmaMaterialOutOtherDetail/${id}`,
      method: 'delete'
    })
  }