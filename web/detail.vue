<template>
  <basic-container class="outTheFront-container-detail">
    <basic-handler>
      <el-button type="primary" size="small" icon="el-icon-plus" @click="clickAdd" plain>新增</el-button>
      <el-button :disabled="disabledAudit" type="primary" size="small" icon="el-icon-if-save" @click="clickSave()"
                 plain>保存
      </el-button>
      <el-button :disabled="disabledDelete" type="danger" size="small" icon="el-icon-delete" @click="clickDelete" plain>删除
      </el-button>
      <el-button :disabled="disabledAuditTwo" type="primary" size="small" icon="el-icon-if-auth" @click="clickAudit" plain>审核
      </el-button>
    </basic-handler>
    <el-collapse v-model="activeNames">
      <el-collapse-item title="基本信息" name="1">
        <el-form :model="ruleForm.bpmaMaterialInInoutMaster" :rules="rules" ref="refRuleForm" label-width="120px"
                 class="form-container" :show-message="false">
          <el-row :gutter="10">
            <el-col :span="8">
              <basic-form-item label="审核状态" prop="validateStatus">
                <el-input clearable size="small"
                          v-model="ruleForm.bpmaMaterialInInoutMaster.validateStatus ==1?'已审核':'未审核'" disabled
                          maxlength="100">
                </el-input>
              </basic-form-item>
            </el-col>
            <el-col :span="8">
              <basic-form-item label="单据编码" prop="code">
                <el-input clearable size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.code" disabled
                          placeholder="系统自动生成单据编码" maxlength="100"></el-input>
              </basic-form-item>
            </el-col>
            <el-col :span="8">
              <basic-form-item label="单据名称" prop="name">
                <el-input ref="refName" clearable size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.name" :disabled="disabledAudit"
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <basic-form-item label="项目名称" prop="proName">
                <el-input ref="refProName" placeholder="请选择项目名称" size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.proName"
                           :disabled="disabledAudit" readonly>
                  <el-button slot="append" icon="el-icon-plus" @click="clickByDialogAddData('proName')" :disabled="disabledAudit"
                             size="mini">
                  </el-button>
                </el-input>
              </basic-form-item>
            ...
            <el-col :span="8">
              <basic-form-item label="供方单位" prop="offerEnterpriseName">
                <el-input ref="refOfferEnterpriseName" placeholder="请选择供方单位" size="small"
                          v-model="ruleForm.bpmaMaterialInInoutMaster.offerEnterpriseName" :disabled="disabledAudit" readonly>
                  <el-button slot="append" icon="el-icon-plus" @click="clickByDialogAddData('offerEnterpriseName')"
                             :disabled="disabledAudit" size="mini"></el-button>
                </el-input>
              </basic-form-item>
            </el-col>
            <el-col :span="8">
              <basic-form-item label="合同名称" prop="contractName">
                <el-input placeholder="请选择合同名称" size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.contractName"
                          :disabled="disabledAudit" readonly>
                  <el-button slot="append" icon="el-icon-plus" @click="clickByDialogAddData('contractName')"
                             :disabled="ifContract" size="mini"></el-button>
                </el-input>
              </basic-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="10">
            <el-col :span="8">
              <basic-form-item label="是否垫付" prop="ifSubstitutePay" class="add-border">
                <el-radio-group v-model="ruleForm.bpmaMaterialInInoutMaster.ifSubstitutePay" @change="changePriseType">
                  <el-radio :label="parseInt(row.code)" v-for="(row,index) in dataEnum.isOrNot" :key="index"
                            :disabled="disabledAudit"> {{ row.name }}
                  </el-radio>
                </el-radio-group>
              </basic-form-item>
            </el-col>
            <el-col :span="8">
              <basic-form-item label="垫付人员" prop="payPerson">
                <el-input :disabled="disabledAudit || ruleForm.bpmaMaterialInInoutMaster.ifSubstitutePay == 2" readOnly
                          placeholder="请选择垫付人员" v-model="ruleForm.bpmaMaterialInInoutMaster.payPerson" size="small">
                  <el-button @click="clickWindow('userManager')" class="el-button-append" icon="el-icon-plus" size="mini"
                             :disabled="disabledAudit || ruleForm.bpmaMaterialInInoutMaster.ifSubstitutePay == 2"
                             slot="append"></el-button>
                </el-input>
              </basic-form-item>
            </el-col>
            <el-col :span="8">
              <basic-form-item label="采购总价" prop="buyTotalPrice">
                <basic-input
                  clearable
                  size="small"
                  :format="formatToThousands"
                  :formatValue="formatToMoney"
                  v-model="ruleForm.bpmaMaterialInInoutMaster.buyTotalPrice"
                  placeholder="自动生成采购总价"
                  :min="0.0000"
                  :disabled="true"
                ></basic-input>
              </basic-form-item>
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <basic-form-item label="领用单位类型" prop="useEnterpriseType" class="add-border">
                <el-radio-group v-model="ruleForm.bpmaMaterialInInoutMaster.useEnterpriseType"
                                @change="changePriseType">
                  <el-radio :label="parseInt(row.code)" v-for="(row,index) in dataEnum.static.useEnterpriseType" :key="index"
                            :disabled="disabledAudit"> {{ row.name }}
                  </el-radio>
                </el-radio-group>
              </basic-form-item>
            ...
            <el-col :span="8">
              <basic-form-item label="领用单位" prop="useEnterpriseName">
                <el-input ref="refUseEnterpriseName" placeholder="请选择领用单位" size="small"
                          v-model="ruleForm.bpmaMaterialInInoutMaster.useEnterpriseName" :disabled="disabledAudit" readonly>
            ...
            <el-col :span="8">
              <basic-form-item label="领用总价" prop="useTotalPrice">
                <basic-input
                  clearable
                  size="small"
                  :format="formatToThousands"
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <basic-form-item label="送货人员" prop="deliverPerson">
                <el-input clearable size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.deliverPerson"
                          placeholder="请输入送货人员" :disabled="disabledAudit" maxlength="100"></el-input>
              </basic-form-item>
            </el-col>
            <el-col :span="8">
              <basic-form-item label="领用人员" prop="usePerson">
                <el-input clearable size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.usePerson"
                          placeholder="请输入领用人员" :disabled="disabledAudit" maxlength="100"></el-input>
              </basic-form-item>
            </el-col>
            <el-col :span="8">
              <basic-form-item label="业务日期" prop="handleDate" class="showTime">
                <el-date-picker
                  :clearable="false"
                  size="small"
                  :editable="false"
          ...
          <el-row :gutter="10">
            <el-col :span="24">
              <basic-form-item label="补充说明" prop="remark">
                <el-input type="textarea" :disabled="disabledAudit" maxlength="200" clearable
                          :autosize="{ minRows: 2, maxRows: 5}" placeholder="请输入补充说明"
                          v-model="ruleForm.bpmaMaterialInInoutMaster.remark"></el-input>
              </basic-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="10">
            <el-col :span="24">
              <el-form-item label="文档附件" class="add-border file">
                <basic-upload ref="refBasicUpload" :formId="ruleForm.bpmaMaterialInInoutMaster.id" :disabled="disabledAudit">
                </basic-upload>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="10">
            <el-col :span="8">
              <basic-form-item label="是否报销" prop="ifPay" class="add-border disabled">
                <el-radio-group v-model="ruleForm.bpmaMaterialInInoutMaster.ifPay" :disabled="!disabledAudit"
                                @change="changePriseType">
            ...
            <el-col :span="8">
              <basic-form-item label="报销金额" prop="payedPrice">
                <el-input clearable size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.payedPrice" disabled
                          maxlength="100"></el-input>
              </basic-form-item>
            </el-col>
            <el-col :span="8">
              <basic-form-item label="报销单号" prop="payedCode">
                <el-input clearable size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.payedCode" disabled
                          maxlength="100"></el-input>
              </basic-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="10">
            <el-col :span="8">
              <basic-form-item label="是否抵扣" prop="ifDeduct" class="add-border disabled">
                <el-radio-group v-model="ruleForm.bpmaMaterialInInoutMaster.ifDeduct" :disabled="disabledAudit"
                                @change="changePriseType">
                  <el-radio :label="parseInt(row.code)" disabled
                            v-for="(row, key, index) in dataEnum.isOrNot" :key="row.code">
                    {{ row.name }}
            ...
            <el-col :span="8">
              <basic-form-item label="抵扣金额" prop="deductPrice">
                <el-input clearable size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.deductPrice" disabled
                          maxlength="100"></el-input>
              </basic-form-item>
            </el-col>
            <el-col :span="8">
              <basic-form-item label="抵扣单号" prop="deductCode">
                <el-input clearable size="small" v-model="ruleForm.bpmaMaterialInInoutMaster.deductCode" disabled
                          maxlength="100"></el-input>
              </basic-form-item>
            </el-col>
          </el-row>
    ...
    <el-row class="content-container">
      <basic-handler>
        <el-button type="primary" size="small" icon="el-icon-plus" @click="clickWindow('materialDictionary')" :disabled="disabledAudit" plain>引入物资
        </el-button>
        <el-button type="danger" size="small" icon="el-icon-delete" @click="clickGoods" plain
                   :disabled="!disabledAudit && Object.keys(selectArray).length?false:true">删除
        </el-button>
      ...
      <basic-table ref="refOutTheFrontTable" :dataTable="dataStockGoodsData" :columns="columnsData.itemColumns"
          ...
          <el-form :model="dataStockGoodsData.data[obj.scope.$index]" :ref="'formBuySum' + obj.scope.$index"
            ...
            <el-form-item prop="buySum">
              <basic-input clearable size="small"  :format="formatToThousandsFour"
                           ...
                           :min="0.0000"
                           @change="sumChange(obj.scope.row)" :disabled="disabledAudit"></basic-input>
            </el-form-item>
          </el-form>
        </template>
        ...
        <template slot-scope="obj" slot="ifChangePrice">
          <el-radio-group v-model="obj.scope.row.ifChangePrice" :disabled="disabledAudit"
        ...
        <template slot-scope="obj" slot="useUnitPrice">
          <el-form :model="dataStockGoodsData.data[obj.scope.$index]" :ref="'formUseUnitPrice' + obj.scope.$index"
                   :show-message="false">
            <el-form-item prop="useUnitPrice">
              <basic-input clearable size="small"  :format="formatToThousandsFour"
                           :formatValue="formatToMoneyFour" v-model="obj.scope.row.useUnitPrice" placeholder="请输入领用单价"
                           :disabled="obj.scope.row.ifChangePrice==2?true:false||disabledAudit" :min="0.0000"
        ...
        <template slot-scope="obj" slot="useTotalPrice">
          {{formatToThousandsFour(obj.scope.row.useTotalPrice)}}
        </template>
        ...
        <template slot-scope="obj" slot="remark">
          <basic-input clearable size="small"  v-model="obj.scope.row.remark" placeholder="备注"
                       :disabled="disabledAudit"></basic-input>
        </template>
      </basic-table>
    </el-row>
  ...
  export default {
          ...
          payPerson:[
            {
              required: false,
              validator: (rule, value, callback) => {
                if (this.ruleForm.bpmaMaterialInInoutMaster.ifSubstitutePay == 1) {
          ...
          useUnitPrice:[
            {
              required: true,
              validator: (rule, value, callback) => {
                validateValue(rule, value, callback, true, ['领用单价', 0, 100000000]);
              },
              trigger: 'change'
            }
          ]
    ...
    methods: {
      ...
      clickHandleOk() {
        ...
        switch (this.type) {
          case 'project':
            ...
            this.$set(this.ruleForm.bpmaMaterialInInoutMaster, 'proName', row.name)
            this.$set(this.ruleForm.bpmaMaterialInInoutMaster, 'proId', row.id)
            this.$set(this.ruleForm.bpmaMaterialInInoutMaster, 'proCode', row.code)
            break
          case 'userManager':
            if(!this.isSelectedRow(row)) return false;
            this.$set(this.ruleForm.bpmaMaterialInInoutMaster, 'payPerson', row.username)
            this.$set(this.ruleForm.bpmaMaterialInInoutMaster, 'payPersonId', row.id)
            break
          case 'materialDictionary':
            ...
            this.$refs.refOutTheFrontTable.setCurrentRow(this.dataStockGoodsData.data[0]);
            this.computeSummary();
      ...
      clickAdd() {
        ...
        return this.$utilsBasic.valideFocus(this, ['refProName','refOfferEnterpriseName','refUseEnterpriseName']);
      },
      sumChange(data) {
       ...
       * */
      computeSummary(){
        let result = this.$utilsBasic.computeSummaryData(this.dataStockGoodsData.data, ['buyTotalPrice', 'useTotalPrice']);
        this.ruleForm.bpmaMaterialInInoutMaster.buyTotalPrice = this.$utilsBasic.toMoney(result.buyTotalPrice, 2);
        this.ruleForm.bpmaMaterialInInoutMaster.useTotalPrice = this.$utilsBasic.toMoney(result.useTotalPrice, 2);
      },
      clickByDialogAddData(type) {
        ...
        if (type == "goodsItem") {
          ...
          if (!this.ruleForm.bpmaMaterialInInoutMaster.proId) return this.$message.warning("请先选择项目");
          if (!this.ruleForm.bpmaMaterialInInoutMaster.offerEnterpriseId) return this.$message.warning("请先选择供方单位");
          this.$refs.refMaterialContract.openDialog();
      ...
      handleChange(type) {
        ...
        switch (type) {
          ...
          case "visibleSyncOfferEnterprise":
            ...
            this.ruleForm.bpmaMaterialInInoutMaster.offerEnterpriseName = row.name;
            this.$set(this.ruleForm.bpmaMaterialInInoutMaster,'contractId',undefined);
            this.$set(this.ruleForm.bpmaMaterialInInoutMaster,'contractName',undefined);
            break;
        }
        this[type] = false;
      },
      ...
      //改变领用类型
      changePriseType() {
        this.$set(this.ruleForm.bpmaMaterialInInoutMaster,'payPersonId',undefined);
        this.$set(this.ruleForm.bpmaMaterialInInoutMaster,'payPerson',undefined);
