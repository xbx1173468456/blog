...
export function getList(data) {
  return request({
    url: '/api/bpma/bpmaMaterialCheckMaster/page',
    method: 'get',
    params: data
  })
}
...
export function getDetail(id) {
  return request({
    url: `/api/bpma/bpmaMaterialCheckMaster/getMasterAndDetail/${id}`,
    method: 'get'
  })
}
//查看比选列表详情
...
export function add(data) {
  return request({
    url: '/api/bpma/bpmaMaterialCheckMaster/addOrUpdateEnterprise',
    method: 'post',
    data: data
  })
}
...
export function audit(data) {
  return request({
    url: '/api/bpma/bpmaMaterialCheckMaster/audit',
    method: 'put',
    data: data
  })
}
...
export function del(id) {
  return request({
    url: `/api/bpma/bpmaMaterialCheckMaster/deleteMasterAndDetail/${id}`,
    method: 'delete'
  })
}
//报价单位信息
...
export function getMaterial(params) {
  ...
  export function delDetail(id) {
    return request({
      url: `/api/bpma/bpmaMaterialCheckDetail/${id}`,
      method: 'delete'
    })
  }