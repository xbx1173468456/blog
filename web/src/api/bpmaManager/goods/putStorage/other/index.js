...
export function getList(data) {
  return request({
    url: '/api/bpma/bpmaMaterialInOtherMaster/page',
    method: 'get',
    params: data
  })
}
...
export function getDetail(id) {
  return request({
    url: `/api/bpma/bpmaMaterialInOtherMaster/getMasterAndDetail/${id}`,
    method: 'get'
  })
}
//查看比选列表详情
...
export function add(data) {
  return request({
    url: '/api/bpma/bpmaMaterialInOtherMaster/addOrUpdateEnterprise',
    method: 'post',
    data: data
  })
}
...
export function audit(data) {
  return request({
    url: '/api/bpma/bpmaMaterialInOtherMaster/audit',
    method: 'put',
    data: data
  })
}
...
export function del(id) {
  return request({
    url: `/api/bpma/bpmaMaterialInOtherMaster/deleteMasterAndDetail/${id}`,
    method: 'delete'
  })
}
//报价单位信息
...
export function getMaterial(params) {
  ...
  export function delDetail(id) {
    return request({
      url: `/api/bpma/bpmaMaterialInOtherDetail/${id}`,
      method: 'delete'
    })
  }
