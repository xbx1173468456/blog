...
<script>
  ...
  import {
    getProjectList,
    getFinanceBusinessExpenseMaster
  ...
  export default {
    ...
    methods: {
      ...
      getFinanceBusinessExpenseMaster() {
        ...
        getFinanceBusinessExpenseMaster(this.modelSearchFilter).then(res => {
          this.formData = {}
      ...
      contractChange(data) {
        ...
        this.getFinanceBusinessExpenseMaster()
      },
      addClick(lock) {
        ...
        if (lock) {
          ...
          this.$router.push({
            path: `/bpmaManager/finance/cost/businessReimbursement/id/0/${formData.id}`,
            query: this.proData
          })
        }
      },
