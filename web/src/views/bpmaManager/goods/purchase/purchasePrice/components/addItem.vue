        ...
        <el-row>
          <el-col :span="8" class="mt10 pdr10">
            <basic-table-tree :default-expand-all="defaultExpandAll" :data="treeTableData" :columns="treeColumns" border
              ...
              <template slot-scope="treeObj" slot="offerExpiryDate">
                {{treeObj.scope.row.offerExpiryDate ? treeObj.scope.row.offerExpiryDate.split(' ')[0] : ''}}
              </template>
            </basic-table-tree>
          </el-col>
          <el-col :span="16">
            <tableItem :columns="columns" :tableData="tableData" :page="page" :highlight="true"
              ...
              :typeTable="true" :type="selection" @currentPage="currentPage"></tableItem>
          </el-col>
        </el-row>
      </div>
