  ...
  <div class="personDialog">
    <basic-dialog v-el-drag-dialog :title="title" :visible.sync="dialogTableVisible">
      <div v-if="this.type ==2">
        <tableItem :columns="columns" :tableData="tableData" :page="page" :highlight="true" :selection="selection"
          @handleCurrentChange="handleCurrentChange" :typeTable="true" @currentPage="currentPage"></tableItem>
      </div>
      <div v-if="this.type ==3">
        <tableItem2 :columns="columns" :tableData="tableData" :page="page" :highlight="true"
          @handleCurrentChange="handleCurrentChange" @handleSelectionChange="handleSelectionChange" :typeTable="true"
          :selection="selection2" @currentPage="currentPage" @Theight="Theight"></tableItem2>
      </div>
      <div class="btnPerson">
