      ...
      <el-collapse-item title="基本信息" name="1">
        ...
        >
          ...
          <el-row :gutter="5">
            ...
            <el-col :span="8">
              <el-form-item label="计量人员" prop="enterpriseName" hide-required-asterisk>
                <el-input
                  size="small"
          ...
          <el-row :gutter="5">
            <el-col :span="8">
              <el-form-item label="计量金额" prop="names" hide-required-asterisk>
                <el-input
                  size="small"
                  clearable
                  v-model="completionPayForm.names"
                  :disabled="disabledFlag"
                  ref="refCompletionPayName"
                  placeholder="请输入计量金额"
                  :min="0.00"
  ...
  methods: {
    ...
    handleImportSubStagePay() {
      if (this.$utils.isEmpty(this.completionPayForm.enterpriseId)) {
        this.$message({ message: "请先选择项目名称", type: "warning" });
      } else {
