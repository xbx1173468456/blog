<template>
  <basic-split-pane
    class="bpmaManager-container-list enterTheArenaIndex-container"
    :default-percent="75"
    :min-percent="25"
  >
    <template slot="leftContainer">
      <div class="left-container">
        ...
        <basic-table
          ...
          @pagination="getAllEnterTheArenaData"
        >
    ...
    <template slot="rightContainer">
      <div class="right-container">
        ...
        ></page-select-filter>@refreshData="getAllItem"
      </div>
    </template>
  </basic-split-pane>
</template>
...
export default {
  ...
  methods: {
     ...
     * 获取完工结算列表所有数据
     * */
    getAllEnterTheArenaData() {
      // console.log('this.modelSearchFilter',this.modelSearchFilter)
      getAllEnterTheArena(this.modelSearchFilter)
        .then(res => {
          console.log(res);
