    ...
    <basic-handler>
      <el-form :inline="true" class="left">
        <el-form-item label="合同名称">
          <el-input size="small" placeholder="请输入合同名称"></el-input>
        </el-form-item>
        <el-form-item label="原合同">
          <el-input size="small" placeholder="请输入原合同"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    methods: {
      ...
      getAllSubContractRegistration() {
        ...
        getAllSubContractRegistration(this.modelSearchFilter).then((response) => {
          ...
          //   item.progressPricePayScale = item.progressPricePayScale.toFixed(2)
          //   item.qualityAssurancePriceScale = item.qualityAssurancePriceScale.toFixed(2)
