    ...
    <el-row>
      <el-col :span="14">
        <div class="grid-content">
          <el-button type="primary" size="small" icon="el-icon-plus" @click="addLog()" plain>新增新闻</el-button>
...
import { selectNews } from "@/api/eoaManager/news/index.js";
export default {
  name: "Hello",
  data() {
    return {
  ...
  methods: {
    ...
    addLog() {
      ...
      this.$router.push({
        path: "/eoaManager/information/newsManager/id",
        name: "newsDetail",
        params: { id: 0 }
      });
    },
    ...
    showDetail() {
      ...
      this.$store.dispatch("cacheId", "0");
      this.$router.push({
        path: "/eoaManager/infomation/newsManager/id",
        name: "newsDetail",
    ...
    currentPage(pages) {
      ...
      this.getLogs(this.page.currentPage, this.page.limit);
    },
